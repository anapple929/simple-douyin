...
func (wrapper *tokenWrapper) Call(ctx context.Context, req client.Request, resp interface{}, opts ...client.CallOption) error {
...
//NewTokenWrapper 初始化Wrapper
func NewTokenWrapper(c client.Client) client.Client {
