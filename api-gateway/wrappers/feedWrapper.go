...
func (wrapper *feedWrapper) Call(ctx context.Context, req client.Request, resp interface{}, opts ...client.CallOption) error {
...
//NewFeedWrapper 初始化Wrapper
func NewFeedWrapper(c client.Client) client.Client {
	return &feedWrapper{c}
}
