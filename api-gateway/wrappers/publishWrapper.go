...
func (wrapper *publishWrapper) Call(ctx context.Context, req client.Request, resp interface{}, opts ...client.CallOption) error {
...
//NewPublishWrapper 初始化Wrapper
func NewPublishWrapper(c client.Client) client.Client {
	return &publishWrapper{c}
}
