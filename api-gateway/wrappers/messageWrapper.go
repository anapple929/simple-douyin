...
func (wrapper *messageWrapper) Call(ctx context.Context, req client.Request, resp interface{}, opts ...client.CallOption) error {
...
//NewMessageWrapper 初始化Wrapper
func NewMessageWrapper(c client.Client) client.Client {
	return &messageWrapper{c}
}
